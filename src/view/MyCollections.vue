                ...
                <el-row>
                      ...
                      <el-card>
                           <img
                            ...
                            <div class="card-content">
                                <li class="card-li"> <span> 一只猴子#123</span> 
                                    <img
                            src="../assets/img/network-logo.png"
                            />
                                </li> 
                                <li class="card-li">价格：100flow</li>

                                  <div style="display: flex; align-items: center">
                                    <el-popover placement="right" :width="400" trigger="click">
                                      <template #reference>
                                        <el-button style="margin-right: 16px" >出售</el-button>
                                      </template>
                                     <el-form
                                        ref="formRef"
                                        :model="saleDetails"
                                      ...
                                      <el-form-item
                                        ...
                                        <el-form-item>
                                          <el-button @click="sell(formRef)">上架</el-button>
                                        </el-form-item>
                                      </el-form>
                                    </el-popover>
                                    <el-popover placement="right" :width="400" trigger="click">
                                      <template #reference>
                                        <el-button style="margin-right: 16px">发起夺宝任务</el-button>
                                      </template>
                                      <el-form
                                        ref="eventFormRef"
                                        :model="EventDetails"
                                      ...
                                      >
                                        ...
                                        >
                                          <el-input v-model="EventDetails.price" />
                                        </el-form-item>
                                            <el-form-item label="份数">
                                              <el-radio-group v-model="EventDetails.phr">
                                                <el-radio label="50" />
                                                <el-radio label="100" />
                                                <el-radio label="200" />
                                                <el-radio label="500" />
                                            ...
                                            <el-form-item label="持续时长">
                                              <el-radio-group v-model="EventDetails.duration">
                                                <el-radio label="24小时" />
                                                <el-radio label="36小时" />
                                                <el-radio label="48小时" />
                                              </el-radio-group>
                                      ...
                                      <el-form-item
                                          ...
                                          label="url介绍"
                                        >
                                          <el-input v-model="EventDetails.url" />
                                        </el-form-item>
                                        <el-form-item>
                                          <el-button @click="sponsor(eventFormRef)">发起掘金</el-button>
                                        </el-form-item>
                                      </el-form>
                                    </el-popover>
                                  </div>
                    ...
                    <el-card>
                           <img
                            ...
                            />
                            <div class="card-content">
                                <li class="card-li"> <span> 一只猴子#123</span> </li>
                                 <li class="card-li">价格：100flow</li>
                                <el-button  class="button-loot" @click="getNftList">Buy Now</el-button>
                            </div>
                      </el-card></el-col>
                    <el-col :span="4"><div class="grid-content ep-bg-purple" /><el-card>
                           <img
                            src="https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png"
                            class="image-trade"
                            />
                            <div class="card-content">
                                <li class="card-li"> <span> 一只猴子#123</span> </li>
                                <li class="card-li">价格：100flow</li>
                                <el-button  class="button-loot">Buy Now</el-button>
                            </div>
                      </el-card></el-col>
                    <el-col :span="4"><div class="grid-content ep-bg-purple" /><el-card>
                           <img
 ...
 const getNftList = async () =>{
   try{ 
       let res = await flow.$fcl.query({
          ...
          args:(arg,t)=>[arg("0x7474a2d43838fd13",t.Address)]
        })
        console.log("res==========="+res)
