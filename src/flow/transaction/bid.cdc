...
import PioneerMarketplace from "../cadence/PioneerMarketplace.cdc"
  transaction(activeID: UInt64,listingResourceID: UInt64, storefrontAddress: Address,ticketAmount: UFix64) {
      ...
      let PioneerNFTCollection: &PioneerNFT.Collection{NonFungibleToken.Receiver}
      ...
      prepare(account: AuthAccount) {
          ...
          self.PioneerNFTCollection = account.borrow<&PioneerNFT.Collection{NonFungibleToken.Receiver}>(
